...
const ETHERSCAN_URL = `https://etherscan.io/address/${WALLET}`;

export default function EthereumDonation() {
          ...
          <div className="px-5 pt-4 pb-3 flex flex-col items-center gap-2.5">
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="w-8 h-8 rounded-full bg-[#627eea] border-2 border-white flex items-center justify-center shadow-lg">
                  <span className="text-white font-bold text-[9px] tracking-tight">ETH</span>
                </div>
              </div>
            </div>
            ...
            <div className="w-full flex items-start gap-2.5 bg-primary/5 border border-primary/20 rounded-xl px-3 py-2">
              ...
              <p className="font-sans text-[11px] text-white/45 leading-snug">
                ...
                Envía solo tokens ERC-20 / ERC-721 en la red Ethereum.
              </p>
            </div>
